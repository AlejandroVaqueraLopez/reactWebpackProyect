...
const CssMinimizerWebpackPlugin = require("css-minimizer-webpack-plugin");//we require the copy webpack plugin 
const TerserWebpackPlugin = require("terser-webpack-plugin");//we require the copy webpack plugin 
...
module.exports = {
	...
	plugins: [
		...
		new MiniCssExtractPlugin({
			filename: "assets/[name].[contenthash].css"//hashes are necessary to avoid problems with cache memo
		}),
	...
	optimization: {
		minimize:true,
		minimizer: [
			new CssMinimizerWebpackPlugin(),//to compile and optimize css code
